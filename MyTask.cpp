...
public:
    ...
    // ==================================================
    // RECURSIVE SHOW TASKS
    // ==================================================
    void showTasks(MyTask* temp = nullptr, int counter = 1) {

        // FIRST CALL ONLY
        if (temp == nullptr && counter == 1) {
    ...
    void delete_Task() {
        ...
        if (taskNumber <= 0) {
            cout << "Task number must be positive.\n";
            return;
        }
    ...
    do {
        ...
        try {
            ...
            case 1:
                ...
                manager.addTask(task, importance, dueDate);
            ...
            case 5:
                manager.arrange_by_due_date();
                break;

            case 6:
                manager.arrange_by_importance();
                break;
